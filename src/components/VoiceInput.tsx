          ...
          <div className="flex bg-natural-bg p-0.5 rounded-xl border border-natural-border text-[10px] font-bold">
            <button
              onClick={() => {
                ...
                setGuidedStep(1);
                setTranscript("");
                speakInstructions("Mode pas-à-pas activé. Veuillez dicter votre tension.");
              }}
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-3 gap-2 text-[10px] font-bold text-center">
            ...
            <button
              ...
              className={`p-3 rounded-2xl border transition-all text-left flex flex-col gap-1 cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed ${
                guidedStep === 2
                  ? "border-natural-primary bg-natural-card text-natural-primary shadow-sm"
                  : guidedPulse
                  ? "border-emerald-200 bg-emerald-50/40 text-emerald-800"
            ...
            >
              ...
              <span className="text-[9px] font-mono text-emerald-700 font-normal mt-0.5 block truncate max-w-[100px]">
          ...
          <div className="bg-natural-card/40 border border-natural-border/60 rounded-3xl p-6 text-center space-y-4">
            ...
            <div className="space-y-1 max-w-md mx-auto">
              <h3 className="text-sm font-bold text-natural-dark flex items-center justify-center gap-1.5">
                {guidedStep === 1 && <>🩺 Tension : {liveParsedTension ? <span className="text-emerald-600 underline font-mono text-base">{liveParsedTension}</span> : "Parlez ou saisissez"}</>}
                {guidedStep === 2 && <>💓 Pouls : {liveParsedPulse ? <span className="text-emerald-600 underline font-mono text-base">{liveParsedPulse} bpm</span> : "Parlez ou saisissez"}</>}
                {guidedStep === 3 && <>💬 Commentaire : {transcript ? <span className="text-emerald-600 italic font-sans text-xs">"{transcript}"</span> : "Parlez ou saisissez"}</>}
              </h3>
            ...
            {supportSpeech && (
              <div className="flex flex-col items-center justify-center gap-2 pt-2">
                ...
                <span className="text-[10px] font-bold text-natural-primary uppercase tracking-wider animate-pulse">
        ...
        <div className="space-y-6">
          <div className="flex flex-col items-center py-4 bg-natural-bg/25 border border-natural-border/50 rounded-2xl p-6">
            ...
            <div className="mt-5 text-center">
              ...
              <p className="text-[11px] text-natural-secondary mt-1.5 max-w-xs mx-auto leading-relaxed">
                {isListening
            ...
            {(transcript || isAnalyzing) && (
              <div className="w-full mt-5 bg-white border border-natural-border rounded-2xl p-4 relative shadow-inner">
                <span className="absolute top-2.5 right-3 text-[9px] uppercase tracking-wider text-natural-secondary font-bold font-mono">
                  Texte capturé
                </span>
