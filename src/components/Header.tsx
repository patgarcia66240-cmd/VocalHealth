...
import { HeartPulse, Plus, Sun, Moon, Settings2 } from "lucide-react";
...
export default function Header({ onManualToggle, theme, onThemeToggle, onSettingsToggle }: HeaderProps) {
  return (
